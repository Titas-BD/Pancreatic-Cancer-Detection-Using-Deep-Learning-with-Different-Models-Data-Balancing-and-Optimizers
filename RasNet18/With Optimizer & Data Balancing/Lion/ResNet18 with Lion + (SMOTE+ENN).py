...
def main():
    ...
    # Build ResNet18 with Lion optimizer
    ...
    plt.title("ResNet18 Accuracy (Lion + SMOTE+ENN)")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.show()
    ...
    plt.title("ResNet18 Loss (Lion + SMOTE+ENN)")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.show()
