...
def main():
    ...
    plt.title("ResNet18 Accuracy (RAdam + SMOT)")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.show()
    ...
    plt.title("ResNet18 Loss (RAdam + SMOT)")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.show()
