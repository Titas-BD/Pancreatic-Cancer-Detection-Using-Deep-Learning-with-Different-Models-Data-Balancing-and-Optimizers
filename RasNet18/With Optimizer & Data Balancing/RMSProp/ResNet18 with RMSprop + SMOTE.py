...
def main():
    ...
    X_train, X_test, y_train, y_test, y_train_int, y_test_int = train_test_split(
        X_res, y_resampled, y_int_resampled,
        test_size=test_size,
    ...
    plt.title('ResNet18 Accuracy (RMSprop + SMOTE)')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.legend()
    plt.show()
    ...
    plt.title('ResNet18 Loss (RMSprop + SMOTE)')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.legend()
    plt.show()
