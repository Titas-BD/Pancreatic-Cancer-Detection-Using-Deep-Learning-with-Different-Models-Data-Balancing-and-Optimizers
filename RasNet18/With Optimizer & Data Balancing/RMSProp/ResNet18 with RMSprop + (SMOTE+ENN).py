...
def main():
    ...
    plt.title('ResNet18 Accuracy (RMSprop + SMOTE+ENN)')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.legend()
    plt.show()
    ...
    plt.title('ResNet18 Loss (RMSprop + SMOTE+ENN)')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.legend()
    plt.show()
