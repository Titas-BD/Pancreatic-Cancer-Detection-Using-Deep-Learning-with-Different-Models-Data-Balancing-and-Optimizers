...
def main():
    ...
    plt.title("ResNet18 Accuracy (AdaBelief + SMOTE+ENN)")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.show()
    ...
    plt.title("ResNet18 Loss (AdaBelief + SMOTE+ENN)")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.show()
