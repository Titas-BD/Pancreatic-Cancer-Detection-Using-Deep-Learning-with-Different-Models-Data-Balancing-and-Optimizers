...
def main():
    ...
    plt.title("ResNet18 Accuracy (AdaBelief + Class Weights)")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.show()
    ...
    plt.title("ResNet18 Loss (AdaBelief + Class Weights)")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.show()
