...
def main():
    ...
    # ------------------ SMOTE ------------------
    print("[INFO] Applying SMOTE on flattened image representation...")
    ...
    plt.title("ResNet18 Accuracy (AdaBelief + SMOTE)")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.show()
    ...
    plt.title("ResNet18 Loss (AdaBelief + SMOTE)")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.show()
