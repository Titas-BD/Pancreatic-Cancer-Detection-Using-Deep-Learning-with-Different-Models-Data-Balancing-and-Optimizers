...
def main():
    ...
    y_resampled_cat = to_categorical(y_int_resampled, num_classes=num_classes)
    ...
    del images, labels, images_resampled, y_resampled_cat
    gc.collect()
    ...
    plt.title("ResNet18 Accuracy (AdaBelief + SMOT)")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.show()
    ...
    plt.title("ResNet18 Loss (AdaBelief + SMOT)")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.show()
